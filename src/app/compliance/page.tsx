...
export default function CompliancePage() {
  const attestation = ATTESTATIONS[CURRENT_ATTESTATION_VERSION];
      ...
      <main className="mx-auto w-full max-w-3xl flex-1 px-4 py-8 sm:px-6 sm:py-12">
        ...
        <Card className="mt-4 p-5 sm:p-6">
          ...
          <p className="mt-3 text-sm leading-relaxed text-ink-700">
            ...
            contributors tell us afterwards, which is why the progress bar
            separates receipt-backed amounts from self-reported ones instead of
        ...
        <Card className="mt-4 p-5 sm:p-6">
          ...
          <p className="mt-1 text-xs text-ink-500">
            ...
            Each pledge records which version was shown at the time.
          </p>
